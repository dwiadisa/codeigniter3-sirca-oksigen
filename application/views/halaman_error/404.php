...
<body>
    ...
    <main>
        <div class="container">
            ...
            <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
                <h1>404</h1>
                <h2>Seharusnya kamu gak boleh kesini.. balik lagi yah</h2>
                <a class="btn" href="<?php
                                        ...
                                        ?>">Back to home</a>
                <img src="<?= base_url('assets_dashboard/') ?>assets/img/not-found.svg" class="img-fluid py-5" alt="Page Not Found">
                <div class="credits">
    ...
    <!-- Vendor JS Files -->
    <script src="<?= base_url('assets_dashboard/') ?>assets/vendor/apexcharts/apexcharts.min.js"></script>
    <script src="<?= base_url('assets_dashboard/') ?>assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="<?= base_url('assets_dashboard/') ?>assets/vendor/chart.js/chart.min.js"></script>
    <script src="<?= base_url('assets_dashboard/') ?>assets/vendor/echarts/echarts.min.js"></script>
    <script src="<?= base_url('assets_dashboard/') ?>assets/vendor/quill/quill.min.js"></script>
    <script src="<?= base_url('assets_dashboard/') ?>assets/vendor/simple-datatables/simple-datatables.js"></script>
    <script src="<?= base_url('assets_dashboard/') ?>assets/vendor/tinymce/tinymce.min.js"></script>
    <script src="<?= base_url('assets_dashboard/') ?>assets/vendor/php-email-form/validate.js"></script>

    <!-- Template Main JS File -->
    <script src="<?= base_url('assets_dashboard/') ?>assets/js/main.js"></script>
